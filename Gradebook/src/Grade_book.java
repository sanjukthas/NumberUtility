...
public class Grade_book {
	...
	static JTable AccountTable;
	 ...
	 static double sum=0;
	 static double s_gender_M=0, countforgenderM=0;
	 static double s_gender_F=0, countforgenderF=0;
	...
	public static void report()
	{
		for(int i=0;i<=AccountTable.getRowCount()-1;i++)
		{
			...
			{
				s_gender_M+= Integer.parseInt((String) AccountTable.getValueAt(i, 5));
				countforgenderM+=1;
			}
			if(AccountTable.getValueAt(i, 2).equals("F"))
			{
				s_gender_F+= Integer.parseInt((String) AccountTable.getValueAt(i, 5));
				countforgenderF+=1;
			}
		...
		{
			aveforgenderM=s_gender_M/countforgenderM;
		}
		else
		{
			aveforgenderM=0;
		...
		{
			aveforgenderF=s_gender_F/countforgenderF;
		}
		else
		{
			aveforgenderF=0;
