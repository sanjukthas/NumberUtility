...
public class Account {
	...
	{
		Grade_book.createtable();// Create Account Table

		accounttable=Grade_book.AccountTable;
		...
		while(number>0){
			...
			Grade_book.createaccount(studentname,studentgrade,studentgender,studentmajor,studentstate,Integer.toString(studentscore));
